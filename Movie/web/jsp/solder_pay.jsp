    ...
    <div class="header-inner">
        ...
        <div class="user-info">
            <div class="user-avatar has-login">
                ...
                <span class="caret"></span>
                <ul class="user-menu">
                    <li class="text login-name" title="cpX509580302"><a href="../jsp/solder_profile.jsp">基本信息</a></li>
...
<script  language="JavaScript">
    ...
    var user_id="<%=((Admin)request.getSession().getAttribute("loginAdmin")).getId()%>";
    function jump(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.flag===true){
                    ...
                    alert("座位已被占用!，请重新选择");
                    window.location.href="../html/solder_choose_seat.html?&name="+encodeURI(encodeURI(name))+"&date="+date+"&time="+time+"&hall="+encodeURI(encodeURI(hall))+"&price="+aloneprice+"&movielength="+encodeURI(encodeURI(movielength))+"&movietype="+encodeURI(encodeURI(movietype))+"&language="+encodeURI(encodeURI(language))+"&id="+id;
                }else {
                    alert("系统异常,请联系管理员!");
                }s
            }
